          ...
          <div class="ml-5 space-y-1.5 text-xs">
            <div>
              ...
              <input
                ...
                onInput={(e) =>
                  updateFilter('savitzkyGolay', 'windowSize', Number(e.currentTarget.value))
                }
                class="w-full"
            ...
            <div>
              ...
              <input
                ...
                onInput={(e) =>
                  updateFilter('savitzkyGolay', 'polynomial', Number(e.currentTarget.value))
                }
                class="w-full"
                disabled={!props.filterConfig.savitzkyGolay.enabled}
              />
          ...
          <div class="ml-5 space-y-1.5 text-xs">
            <div>
              ...
              <input
                ...
                onInput={(e) =>
                  updateFilter('movingAverage', 'windowSize', Number(e.currentTarget.value))
                }
                class="w-full"
          ...
          <div class="ml-5 space-y-1.5 text-xs">
            <div>
              ...
              <input
                ...
                onInput={(e) =>
                  updateFilter('butterworth', 'cutoffHz', Number(e.currentTarget.value))
                }
                class="w-full"
